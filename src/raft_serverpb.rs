...
#[derive(PartialEq,Clone,Default)]
pub struct RaftMessages {
    // message fields
    pub msgs: ::protobuf::RepeatedField<RaftMessage>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl RaftMessages {
    ...
    // Param is passed by value, moved
    pub fn set_msgs(&mut self, v: ::protobuf::RepeatedField<RaftMessage>) {
        self.msgs = v;
    }

    // Mutable pointer to the field.
    pub fn mut_msgs(&mut self) -> &mut ::protobuf::RepeatedField<RaftMessage> {
        &mut self.msgs
    }

    // Take field
    pub fn take_msgs(&mut self) -> ::protobuf::RepeatedField<RaftMessage> {
        ::std::mem::replace(&mut self.msgs, ::protobuf::RepeatedField::new())
    }

    pub fn get_msgs(&self) -> &[RaftMessage] {
        &self.msgs
    }
}

impl ::protobuf::Message for RaftMessages {
    fn is_initialized(&self) -> bool {
        for v in &self.msgs {
            if !v.is_initialized() {
                return false;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                let mut fields = ::std::vec::Vec::new();
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<RaftMessage>>(
                    "msgs",
                    |m: &RaftMessages| { &m.msgs },
                    |m: &mut RaftMessages| { &mut m.msgs },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<RaftMessages>(
                    "RaftMessages",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static RaftMessages {
        static mut instance: ::protobuf::lazy::Lazy<RaftMessages> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const RaftMessages,
        };
        unsafe {
            instance.get(RaftMessages::new)
        }
    }
}

impl ::protobuf::Clear for RaftMessages {
    fn clear(&mut self) {
        self.clear_msgs();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for RaftMessages {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RaftMessages {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    essages\x12.\n\x04msgs\x18\x01\x20\x03(\x0b2\x1a.raft_serverpb.RaftMessa\
    ...
    ionR\x06target\x12\x16\n\x06commit\x18\x03\x20\x01(\x04R\x06commit\"\xa6\
    \x01\n\x10RegionLocalState\x12.\n\x05state\x18\x01\x20\x01(\x0e2\x18.raf\
    t_serverpb.PeerStateR\x05state\x12&\n\x06region\x18\x02\x20\x01(\x0b2\
    \x0e.metapb.RegionR\x06region\x12:\n\x0bmerge_state\x18\x03\x20\x01(\x0b\
    2\x19.raft_serverpb.MergeStateR\nmergeState*A\n\tPeerState\x12\n\n\x06No\
    rmal\x10\0\x12\x0c\n\x08Applying\x10\x01\x12\r\n\tTombstone\x10\x02\x12\
    \x0b\n\x07Merging\x10\x03B\x1a\n\x18com.pingcap.tikv.kvprotoJ\xee\x1a\n\
    \x06\x12\x04\0\0^\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\
    \x12\x03\x01\x08\x15\n\t\n\x02\x03\0\x12\x03\x03\x07\x16\n\t\n\x02\x03\
    \x01\x12\x03\x04\x07\x15\n\x08\n\x01\x08\x12\x03\x06\01\n\x0b\n\x04\x08\
    \xe7\x07\0\x12\x03\x06\01\n\x0c\n\x05\x08\xe7\x07\0\x02\x12\x03\x06\x07\
    ...
    \x0b\n\x04\x04\x02\x02\x01\x12\x03\x1d\x04\x14\n\r\n\x05\x04\x02\x02\x01\
    \x04\x12\x04\x1d\x04\x1c\x15\n\x0c\n\x05\x04\x02\x02\x01\x05\x12\x03\x1d\
    \x04\n\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03\x1d\x0b\x0f\n\x0c\n\x05\
    \x04\x02\x02\x01\x03\x12\x03\x1d\x12\x13\n\n\n\x02\x04\x03\x12\x04\x20\0\
    ...
    \x05\x02\0\x01\x12\x03+\x10\x17\n\x0c\n\x05\x04\x05\x02\0\x03\x12\x