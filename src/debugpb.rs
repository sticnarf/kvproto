...
impl GetRegionPropertiesResponse {
    ...
    pub fn clear_middle_key(&mut self) {
        self.middle_key.clear();
    }

    // Param is passed by value, moved
    pub fn set_middle_key(&mut self, v: ::std::vec::Vec<u8>) {
        self.middle_key = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_middle_key(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.middle_key
    }

    // Take field
    pub fn take_middle_key(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.middle_key, ::std::vec::Vec::new())
    }

    pub fn get_middle_key(&self) -> &[u8] {
        &self.middle_key
    }
}
...
impl ::protobuf::Message for GetRegionPropertiesResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.middle_key)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.middle_key.is_empty() {
            my_size += ::protobuf::rt::bytes_size(2, &self.middle_key);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.middle_key.is_empty() {
            os.write_bytes(2, &self.middle_key)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "middle_key",
                    |m: &GetRegionPropertiesResponse| { &m.middle_key },
                    |m: &mut GetRegionPropertiesResponse| { &mut m.middle_key },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gResponse\"\0\x12b\n\x13GetRegionProperties\x12#.debugpb.GetRegionProper\
    tiesRequest\x1a$.debugpb.GetRegionPropertiesResponse\"\0B&\n\x18com.ping\
    cap.tikv.kvproto\xc8\xe2\x1e\x01\xd0\xe2\x1e\x01\xe0\xe2\x1e\x01J\xb87\n\
    ...
    \x03\x12\x04\xd3\x01\x17\x18\n\x0c\n\x02\x04\x1a\x12\x06\xd6\x01\0\xda\
    ...
    \x04\x19\x1aE\x20The\x20middle\x20key\x20of\x20the\x20region\x20in\x20en\
    coded\x20format,\x20without\x20ts\x20padding.\n\n\x0f\n\x05\x04\x1a\x02\
    \x01\x04\x12\x06\xd9\x01\x04\xd7\x01\x20\n\r\n\x05\x04\x1a\x02\x01\x05\
    \x12\x04\xd9\x01\x04\t\n\r\n\x05\x04\x1a\x02\x01\x01\x12\x04\xd9\x01\n\
    \x14\n\r\n\x05\x04\x1a\x02\x01\x03\x12\x04\xd9\x01\x17\x18b\x06proto3\
";
