...
pub struct GetRegionPropertiesResponse {
    ...
    pub middle_key: ::std::string::String,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl GetRegionPropertiesResponse {
    ...
    // Param is passed by value, moved
    pub fn set_middle_key(&mut self, v: ::std::string::String) {
        self.middle_key = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_middle_key(&mut self) -> &mut ::std::string::String {
        &mut self.middle_key
    }

    // Take field
    pub fn take_middle_key(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.middle_key, ::std::string::String::new())
    }

    pub fn get_middle_key(&self) -> &str {
        &self.middle_key
    }
}
...
impl ::protobuf::Message for GetRegionPropertiesResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.middle_key)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.middle_key.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.middle_key);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.middle_key.is_empty() {
            os.write_string(2, &self.middle_key)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x1d\n\nmiddle_key\x18\x02\x20\x01(\tR\tmiddleKey*#\n\x02DB\x12\x0b\
    ...
    cap.tikv.kvproto\xd0\xe2\x1e\x01\xc8\xe2\x1e\x01\xe0\xe2\x1e\x01J\x977\n\
