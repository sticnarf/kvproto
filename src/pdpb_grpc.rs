...
const METHOD_PD_INTERNAL_SYNC_REGIONS: ::grpcio::Method<super::pdpb::SyncRegionRequest, super::pdpb::SyncRegionResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Duplex,
    name: "/pdpb.PDInternal/SyncRegions",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};

pub struct PdInternalClient {
    client: ::grpcio::Client,
}

impl PdInternalClient {
    pub fn new(channel: ::grpcio::Channel) -> Self {
        PdInternalClient {
            client: ::grpcio::Client::new(channel),
        }
    ...
    pub fn sync_regions_opt(&self, opt: ::grpcio::CallOption) -> ::grpcio::Result<(::grpcio::ClientDuplexSender<super::pdpb::SyncRegionRequest>, ::grpcio::ClientDuplexReceiver<super::pdpb::SyncRegionResponse>)> {
        self.client.duplex_streaming(&METHOD_PD_INTERNAL_SYNC_REGIONS, opt)
    }
...
pub fn create_pd_internal<S: PdInternal + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    let mut builder = ::grpcio::ServiceBuilder::new();
    let mut instance = s.clone();
    builder = builder.add_duplex_streaming_handler(&METHOD_PD_INTERNAL_SYNC_REGIONS, move |ctx, req, resp| {
