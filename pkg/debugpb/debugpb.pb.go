...
type GetRegionPropertiesResponse struct {
	...
	// The middle data key of the region.
	MiddleKey string `protobuf:"bytes,2,opt,name=middle_key,json=middleKey,proto3" json:"middle_key,omitempty"`
}
...
func (m *GetRegionPropertiesResponse) GetMiddleKey() string {
	if m != nil {
		return m.MiddleKey
	}
	return ""
...
func (m *GetRegionPropertiesResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.MiddleKey) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintDebugpb(dAtA, i, uint64(len(m.MiddleKey)))
		i += copy(dAtA[i:], m.MiddleKey)
	}
	return i, nil
}
...
func (m *GetRegionPropertiesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MiddleKey", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MiddleKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDebugpb(dAtA[iNdEx:])
...
var fileDescriptorDebugpb = []byte{
	...
	,
}
