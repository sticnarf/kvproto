...
type TikvClient interface {
	...
	MRaft(ctx context.Context, opts ...grpc.CallOption) (Tikv_MRaftClient, error)
...
func (c *tikvClient) MRaft(ctx context.Context, opts ...grpc.CallOption) (Tikv_MRaftClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Tikv_serviceDesc.Streams[2], c.cc, "/tikvpb.Tikv/MRaft", opts...)
	if err != nil {
		return nil, err
	}
	x := &tikvMRaftClient{stream}
	return x, nil
}

type Tikv_MRaftClient interface {
	Send(*raft_serverpb.RaftMessages) error
	CloseAndRecv() (*raft_serverpb.Done, error)
	grpc.ClientStream
}

type tikvMRaftClient struct {
	grpc.ClientStream
}

func (x *tikvMRaftClient) Send(m *raft_serverpb.RaftMessages) error {
	return x.ClientStream.SendMsg(m)
}

func (x *tikvMRaftClient) CloseAndRecv() (*raft_serverpb.Done, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(raft_serverpb.Done)
...
func _Tikv_MRaft_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TikvServer).MRaft(&tikvMRaftServer{stream})
}

type Tikv_MRaftServer interface {
	SendAndClose(*raft_serverpb.Done) error
	Recv() (*raft_serverpb.RaftMessages, error)
	grpc.ServerStream
}

type tikvMRaftServer struct {
	grpc.ServerStream
}

func (x *tikvMRaftServer) SendAndClose(m *raft_serverpb.Done) error {
	return x.ServerStream.SendMsg(m)
}

func (x *tikvMRaftServer) Recv() (*raft_serverpb.RaftMessages, error) {
	m := new(raft_serverpb.RaftMessages)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var fileDescriptorTikvpb = []byte{
	...
	,
}
